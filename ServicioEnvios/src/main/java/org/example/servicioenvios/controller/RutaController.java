...
// Asociado con los:
// REQ 3) Consultar rutas tentativas con todos los tramos sugeridos y el tiempo y costo estimados. (Operador / Administrador)
// REQ 4) Seleccionar una ruta tentativa para asignarla a la solicitud. (Administrador)
...
public class RutaController {
    ...
    public ResponseEntity<SolicitudResponseDTO> seleccionarRuta(
        ...
        SolicitudResponseDTO solicitudActualizada =
                rutaService.seleccionarRuta(numSolicitud, rutaSeleccionada);
